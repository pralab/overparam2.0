...
def load_pytorch_dataset(seed, dataset, train_subset_size, test_subset_size, batch_size,
    ...
    train_loader = DataLoader(train_set,
                              ...
                              num_workers=0,
                              sampler=sampler.SequentialSampler(random_train_indices))
    val_loader = DataLoader(train_set,
                            batch_size=batch_size,
                            num_workers=0,
                            sampler=sampler.SequentialSampler(random_val_indices))
    ...
    test_loader = DataLoader(test_set,
                             ...
                             shuffle=False,
                             num_workers=0,
                             sampler=sampler.SequentialSampler(random_test_indices))
